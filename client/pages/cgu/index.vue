...
<template>
  ...
  <div class="fr-mt-8w">
    ...
    <p>
      Les présentes conditions générales d’utilisation (dites «&nbsp;CGU&nbsp;») fixent le cadre d’utilisation de
      l’application «&nbsp;Agora&nbsp;». Elles
    ...
    <p>
      ...
      «&nbsp;L’Editeur&nbsp;» de la plateforme Agora est la Direction interministérielle de la transformation publique
      (DITP). Agora est développée au
      sein de l’incubateur de services numériques de la Direction interministérielle du numérique - Beta.gouv et mise en
      œuvre par, et sous
      la responsabilité, de la délégation interministérielle de la transformation publique (DITP).<br><br>
      Une «&nbsp;Consultation&nbsp;» est une question posée par un ministère sur la conception, l’élaboration et la mise
      ...
      Le «&nbsp;Service&nbsp;» correspond aux fonctionnalités offertes par la plateforme Agora pour répondre à ses
      finalités.
    </p>
    ...
    <ul>
      <li>Ne mentionner dans les champs libres aucune donnée à caractère personnel, c’est-à-dire ne mentionner aucune
        donnée qui
        permettrait d’identifier une personne physique&nbsp;;
      </li>
      <li>Respecter le cadre légal qui encadre la liberté d’expression. En conséquence, ne pas utiliser l’application à
        des fins de
    ...
    <ul>
      ...
      <li>Energie ⚡️</li>
      <li>Enfance 👶</li>
      <li>Etudes sup. & recherche 🧬</li>
      <li>Europe & international 🌏</li>
      <li>Handicap 👩‍🦽</li>
      <li>Justice ⚖️</li>
      <li>Logement 🏡</li>
      <li>Outre-mer 🌍</li>
      <li>Santé 🏥</li>
      <li>Sécurité & défense 🛡</li>
    ...
    <p>
      ...
      Chaque Utilisateur peut poser une question au Gouvernement sur l’application, sous réserve de respecter la charte
      de participation. Il
      pourra la partager à son entourage, par message ou sur les réseaux sociaux par exemple, pour l’inciter à la
      soutenir.<br><br>
      La question posée par l’Utilisateur n’apparaîtra dans l’application des autres Utilisateurs qu’une fois validée
      par l’équipe de
      modération. L’Editeur s’engage à ce que cette validation intervienne le plus rapidement possible.<br><br>
      L'Utilisateur veille notamment à&nbsp;:
    <ul>
      <li>Ne mentionner dans les champs libres aucun élément qui permettrait d'identifier, directement ou indirectement
        une personne
        physique&nbsp;;
      </li>
    ...
    <ul>
      ...
      <li>Transports 🚊</li>
      <li>Travail 💼</li>
      <li>Autre / Je ne sais pas 📦</li>
    </ul>
    <br>
    Le ministre concerné ou le porte-parole du gouvernement peut répondre à la question sous la forme d’un texte ou
    d’une vidéo. Les
    ...
    <p>
      ...
      l’équipe de
      modération. Il peut les filtrer par catégories&nbsp;: «&nbsp;Populaires&nbsp;», «&nbsp;Récentes&nbsp;»,
      «&nbsp;Suivies&nbsp;».<br><br>
      L’Utilisateur peut soutenir de façon anonyme autant de questions citoyennes posées par les autres Utilisateurs
      qu’il le souhaite en
    ...
    <h3>4.1 L'Éditeur (DITP)</h3>
    <p>
      Les informations diffusées sur le Service sont réputées fiables mais l’Editeur ne garantit pas qu’elles soient
      exemptes de défauts,
      d’erreurs ou d’omissions.<br><br>
      L’Editeur s’engage à ne pas modifier ou altérer le contenu des propos tenus par l’Utilisateur dès lors qu’ils
      respectent les termes de
      la Charte de participation de l’application.<br><br>
      L'Éditeur assure la modération de l’application. A ce titre, il se réserve le droit de supprimer les propos
      notamment&nbsp;: xénophobes,
      prosélytes, diffamatoires, irrespectueux, injurieux, sexistes, racistes, harcelants, pornographiques, de nature à
      troubler l’ordre
      public, les fausses informations ou encore toutes formes de publicité commerciale.<br><br>
      L’Editeur s’engage à la sécurisation de la plateforme, notamment en prenant toutes les mesures nécessaires
      permettant de garantir la
      sécurité et la confidentialité des informations fournies.<br><br>
      L'Éditeur fournit les moyens nécessaires et raisonnables pour assurer un accès continu à l’application. Il se
      réserve la liberté de
      faire évoluer, de modifier ou de suspendre, sans préavis, l’application pour des raisons de maintenance ou pour
      tout autre motif jugé
      nécessaire.
    </p>
    ...
    <p>
      ...
      notamment les données qui révèlent l'origine raciale ou ethnique supposée, les opinions politiques, les
      ...
      des informations contraires aux dispositions légales et réglementaires en vigueur. Dans le cas contraire,
      l’Editeur se réserve le
      droit de supprimer ces contenus.<br><br>
      Il est notamment rappelé que&nbsp;:
    <ul>
      <li>toute personne procédant à une fausse déclaration pour elle-même ou pour autrui s’expose, notamment, aux
        sanctions prévues à
        l’article 441-1 du code pénal, prévoyant des peines pouvant aller jusqu’à trois ans d’emprisonnement et 45 000
        euros d’amende&nbsp;;
      </li>
      <li>tout propos injurieux ou diffamatoire est susceptible d’être sanctionné au titre du code pénal et de la loi du
        29 juillet 1881
        sur la liberté de la presse.
      </li>
    </ul>
    <br>
    L’Utilisateur s’engage à ne pas commercialiser les éléments reçus dans le cadre de cette application.<br>
    L'Éditeur s’autorise à supprimer, sans préavis ni indemnité d’aucune sorte, les contenus faisant l’objet d’une
    utilisation
    contrevenante
    ...
    <p>
      ...
      Service, de l’évolution de la législation ou pour tout autre motif jugé nécessaire.
    </p>
  </div>
</template>
